...
RSpec.describe ReservationBuilder do
  ...
  describe '#build' do
    shared_examples 'valid_reservation' do
    ...
    context 'with payload format 1' do
      subject(:reservation) { described_class.new(payload_1).build }

      include_examples 'valid_reservation'
    end

    context 'with payload format 2' do
      subject(:reservation) { described_class.new(payload_2).build }
  ...
  describe '#errors' do
    context 'with payload format 1' do
      subject(:builder) { described_class.new(payload_1) }
    ...
    context 'with payload format 2' do
      subject(:builder) { described_class.new(payload_2) }
